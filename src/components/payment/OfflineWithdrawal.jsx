...
import { Calendar, Clock, TrendingUp, Sparkles, Zap, Target, DollarSign, Shield } from "lucide-react";
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">Plan your withdrawals strategically</p>
              </div>
            </div>
            {!loading && (
            ...
            <>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold text-sm mb-1">Secure Payment Schedule</h4>
                    <p className="text-gray-400 text-xs">
                      Your funds are protected and will be processed according to your selected schedule
                    </p>
                  </div>
                </div>
              </motion.div>
