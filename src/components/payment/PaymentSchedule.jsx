...
export default function PaymentSchedule() {
  ...
  return (
    <motion.div
      className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl shadow-2xl p-8 border-2 border-green-400/50 backdrop-blur-sm mb-4 overflow-hidden"
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={updating}
                  className="w-full bg-gray-800 border-2 border-gray-700 text-white text-base font-semibold p-4 rounded-2xl focus:border-green-400 focus:outline-none transition-colors duration-300 appearance-none cursor-pointer"
                >
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-yellow-500/10 to-green-500/10 border-2 border-yellow-500/30 rounded-2xl p-6 mb-6 backdrop-blur-sm"
            >
