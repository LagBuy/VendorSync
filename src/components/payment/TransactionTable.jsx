...
import { ArrowDownLeft, ArrowUpRight, FileText, Download, Sparkles, Filter, Search, Zap } from "lucide-react";
...
export default function TransactionTable() {
  ...
  const statusBadge = (status) => {
    const base = "px-3 py-1 rounded-xl text-xs font-semibold border backdrop-blur-sm";
    ...
    if (status === "Failed") return `${base} bg-red-500/20 text-red-400 border-red-500/30`;
  ...
  return (
    <>
      ...
      <motion.div
        className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl shadow-2xl p-8 border border-gray-800 backdrop-blur-sm mb-10 overflow-hidden"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-2xl pl-10 pr-4 py-3 text-white placeholder-gray-400 focus:border-yellow-500 focus:outline-none transition-colors duration-300"
              />
            </div>
            ...
            <select
              ...
              className="bg-gray-800 border border-gray-700 rounded-2xl px-4 py-3 text-white focus:border-yellow-500 focus:outline-none transition-colors duration-300"
            >
            ...
            <motion.button
              ...
              className="flex items-center justify-center bg-gradient-to-r from-gray-700 to-gray-800 text-white font-bold py-3 px-4 rounded-2xl border border-gray-600 hover:border-yellow-500/50 transition-all duration-300"
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="text-white font-semibold">Transactions Summary</h4>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-gray-700">
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Date & Time</th>
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Type</th>
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Amount</th>
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Description</th>
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Attachment</th>
                    <th className="py-4 px-6 text-left text-gray-400 font-semibold text-sm">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <AnimatePresence>
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  ...
                  <p className="text-yellow-500 font-bold text-lg">{transactions.length}</p>
                </div>
                <div>
